...
pub const RenderMode = @import("rendering.zig").RenderMode;
pub const EmitTarget = @import("source_emission.zig").EmitTarget;
pub const EmitMode = @import("source_emission.zig").EmitMode;
