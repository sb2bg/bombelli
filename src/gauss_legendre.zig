...
pub fn make(
    ...
    if (!@hasField(Options, "variable")) {
        @compileError("Bombelli quadrature options require '.variable'");
    }
    if (!@hasField(Options, "rule")) {
        @compileError("Bombelli quadrature options require '.rule'");
    }
    if (!@hasField(Options, "order")) {
        @compileError("Bombelli quadrature options require '.order'");
    }
