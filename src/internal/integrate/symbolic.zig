...
const domain_module = @import("../core/domain.zig");
...
const substitution = @import("../transform/substitution.zig");
...
pub const IntegralBounds = types.IntegralBounds;
...
pub const PartialIntegral = struct {
    ...
    ) @import("hybrid.zig").HybridIntegral(options.order) {
        return @import("hybrid.zig").compilePartial(self, options);
    }
};
...
pub fn makeProblem(
    ...
    options_validation.requireField(
        Options,
        "variable",
        "Bombelli integration options require '.variable'",
    );
    options_validation.requireField(
        Options,
        "domain",
        "Bombelli integration options require '.domain'",
    );
