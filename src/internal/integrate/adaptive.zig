...
pub fn make(
    ...
    options_validation.requireField(
        Options,
        "variable",
        "Bombelli adaptive quadrature options require '.variable'",
    );
    options_validation.requireField(
        Options,
        "max_depth",
        "Bombelli adaptive quadrature options require '.max_depth'",
    );
    options_validation.requireField(
        Options,
        "tolerance",
        "Bombelli adaptive quadrature options require '.tolerance'",
    );
